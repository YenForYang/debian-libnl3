...
union YYSTYPE
{
#line 18 "/dev/shm/systemd/test/deps/test/lvm2/tmp/corosync/tmp/libnl3/libnl3-3.4.0/./lib/route/pktloc_syntax.y" /* yacc.c:1906  */

	struct rtnl_pktloc *l;
	uint32_t i;
	char *s;

#line 77 "lib/route/pktloc_syntax.h" /* yacc.c:1906  */
};
